...
This is a bookshelf app that allows you to select and categorize books you have read, are currently reading,
or want to read.
...
* install all project dependencies with `npm install` (or `yarn install` if you prefer using yarn)
* start the development server with `npm start` or (or `yarn start` if you prefer using yarn)
...
└── src
    ...
    └── views
        ├── BookCard.js # The card used by book
        ├── BookSearch.js # The books search page
        └── BooksIndex.js # The main page, listing all books
